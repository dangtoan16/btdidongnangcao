            ...
            <View style={{ backgroundColor: appColors.primary, paddingTop: 35 }}>
                <RowComponent justify='space-between' styles={{ paddingHorizontal: 12, paddingVertical: 8 }}>
                    ...
                    <RowComponent>
                        ...
                        <AvatarItem size={36} photoUrl='https://photo.znews.vn/w660/Uploaded/vpibtwvo/2025_01_31/Betterimage.ai_1738298235454.jpeg' />
                    </RowComponent>
                </RowComponent>
            </View>
            <ScrollView>
                ...
                <SectionComponent >
                    <TextComponent text='Thể loại' size={20} />
                    <SpaceComponent height={12} />
                    <FlatList
                        data={categories}
                        horizontal
                ...
                <SectionComponent >
                    <TextComponent text='Sản phẩm bán chạy' size={20} />
                    <SpaceComponent height={12} />
                    <FlatList
                        data={events}
                        horizontal
